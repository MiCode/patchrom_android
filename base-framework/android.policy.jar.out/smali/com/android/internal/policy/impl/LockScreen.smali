...
.method constructor <init>(Landroid/content/Context;Landroid/content/res/Configuration;Lcom/android/internal/widget/LockPatternUtils;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Lcom/android/internal/policy/impl/KeyguardScreenCallback;)V
    ...
    const-string v2, "*** LockScreen accel is "
...
.method static synthetic access$800(Lcom/android/internal/policy/impl/LockScreen;)Lcom/android/internal/widget/LockPatternUtils;
    .locals 1
    .parameter "x0"
...
.method private createUnlockMethods(Landroid/view/View;)Lcom/android/internal/policy/impl/LockScreen$UnlockWidgetCommonMethods;
    ...
    :cond_1
    instance-of v8, p1, Lcom/android/internal/widget/multiwaveview/MultiGlowView;

    if-eqz v8, :cond_2

    move-object v2, p1

    check-cast v2, Lcom/android/internal/widget/multiwaveview/MultiGlowView;

    .local v2, multiWaveView:Lcom/android/internal/widget/multiwaveview/MultiGlowView;
    new-instance v3, Lcom/android/internal/policy/impl/LockScreen$MultiWaveViewMethods;

    invoke-direct {v3, p0, v2}, Lcom/android/internal/policy/impl/LockScreen$MultiWaveViewMethods;-><init>(Lcom/android/internal/policy/impl/LockScreen;Lcom/android/internal/widget/multiwaveview/MultiGlowView;)V

    .local v3, multiWaveViewMethods:Lcom/android/internal/policy/impl/LockScreen$MultiWaveViewMethods;
    invoke-virtual {v2, v3}, Lcom/android/internal/widget/multiwaveview/MultiGlowView;->setOnTriggerListener(Lcom/android/internal/widget/multiwaveview/MultiGlowView$OnTriggerListener;)V

    move-object v4, v3

    goto :goto_0

    .end local v2           #multiWaveView:Lcom/android/internal/widget/multiwaveview/MultiGlowView;
    .end local v3           #multiWaveViewMethods:Lcom/android/internal/policy/impl/LockScreen$MultiWaveViewMethods;
    :cond_2
